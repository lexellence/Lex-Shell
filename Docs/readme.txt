...
appName > <outputFile>: Execute a program (no arguments supported) from the current working directory and redirect its output to outputFile (use >> for append version)
